        ...
        <>
            ...
            <div className="mx-auto max-w-7xl px-3 pt-12">
                <div className="flex  flex-col gap-3  lg:flex-row">
                    <div className="flex w-full min-w-fit flex-col gap-3 lg:h-screen lg:w-fit">
                        <List>
                            <Header>
                        ...
                        <List>
                            ...
                            <div className="px-2 py-3">
                                <h1 className="flex flex-row justify-between">
                                    ...
                                    <span>
                                        {
                                            currentSelectedLibrary?.documents
                                                .length
                                        }
                                    </span>
                                </h1>
                            ...
                            <div className="max-h-60 overflow-x-hidden overflow-y-scroll border-t border-t-gable-800 p-2">
                                ...
                                {isLoading ? (
                                    <Loading
                                        ...
                                        className="py-2"
                                    />
                                ) : currentSelectedLibrary?.jobs.length !==
                                  0 ? (
                                    currentSelectedLibrary?.jobs.map(
                                        (job: Job) => {
                                            return (
                                                <>
                                                    <div
